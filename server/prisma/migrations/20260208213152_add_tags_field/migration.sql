...
INSERT INTO "new_Idea" ("createdAt", "description", "globalCounter", "id", "ideaNumber", "isSidelined", "opportunity", "ownerId", "stageGate", "teamId", "title", "updatedAt") SELECT "createdAt", "description", "globalCounter", "id", "ideaNumber", "isSidelined", "opportunity", "ownerId", "stageGate", "teamId", "title", "updatedAt" FROM "Idea";
DROP TABLE "Idea";
